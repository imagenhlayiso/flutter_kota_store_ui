...
const TextTheme TEXT_THEME_DATA = TextTheme(
  headline1:
...
const TextTheme TEXT_THEME_SMALL = TextTheme(
  headline1:
      TextStyle(color: COLOR_BLACK, fontSize: 22, fontWeight: FontWeight.w700),
  headline2:
      TextStyle(color: COLOR_BLACK, fontSize: 20, fontWeight: FontWeight.w700),
  headline3:
      TextStyle(color: COLOR_BLACK, fontSize: 18, fontWeight: FontWeight.w700),
  headline4:
      TextStyle(color: COLOR_BLACK, fontSize: 14, fontWeight: FontWeight.w700),
  headline5:
      TextStyle(color: COLOR_BLACK, fontSize: 12, fontWeight: FontWeight.w700),
  headline6:
      TextStyle(color: COLOR_BLACK, fontSize: 10, fontWeight: FontWeight.w700),
);
